<template>
    <v-dialog dense v-model="getVisible" @input="closeDialog()">
        <v-card>
            <v-card-text>
                <FormuiDepartmentTableComp @item-selected="selectedItem" :singleSelect="true"></FormuiDepartmentTableComp>
            </v-card-text>
            <v-divider></v-divider>
            <v-card-actions>
                <v-spacer></v-spacer>
...
@Component
export default class DepartmentDialogTable extends Vue {
