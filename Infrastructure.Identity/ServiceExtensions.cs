...
namespace Infrastructure.Identity
{
    ...
    {
        public static void AddIdentityInfrastructureOLD(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddIdentity<ApplicationUser, Role>().AddEntityFrameworkStores<IdentityContext>().AddDefaultTokenProviders();
