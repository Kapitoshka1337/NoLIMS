...
class NewTab extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('res_samples', function (Blueprint $table) {
            $table->primary('id');
        ...
        Schema::create('res_indicators', function (Blueprint $table) {
            $table->primary('id');
            $table->bigIncrements('id_department')->unique();
            $table->string('name');
            $table->string('metod');
        });

        Schema::create('res_direction', function (Blueprint $table) {
            $table->primary('id');
            $table->bigIncrements('id_samples')->unique();
            $table->bigIncrements('id_indicator')->unique();
            $table->string('massa');
            $table->boolean('SI');
            $table->boolean('metod');
            $table->string('note');
    ...
    {
        Schema::dropIfExists('res_samples');
        Schema::dropIfExists('res_indicators');
        Schema::dropIfExists('res_direction');
    }
