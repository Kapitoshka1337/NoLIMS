...
class ManufacturerView extends React.PureComponent {
    ...
    this.state = {
      ...
      columns: [
        ...
        },
        {
          ...
          dataIndex: "country",
          width: 200,
          sorter: (a, b) => (a.country - b.country > 0 ? 1 : -1),
        },
        {
          type: "text",
          filterIndex: "city",
          ...
          dataIndex: "city",
          width: 200,
          sorter: (a, b) => (a.city - b.city > 0 ? 1 : -1),
        },
        {
          inFilter: false,
          inAppearance: false,
  ...
  getData = async (page, size, sorter) => {
    ...
    if (typeof page == "undefined" && typeof size == "undefined") {
      const data = await agent.ManufacturerService.view(
  ...
  handleDelete = async () => {
    ...
    const result = await agent.ManufacturerService.delete(
