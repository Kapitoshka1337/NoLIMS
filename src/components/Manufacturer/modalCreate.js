...
class ModalCreateManufacturer extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    handleOk() {
        ...
        .then((values) => {
            let result = agent.ManufacturerService.add(values);
            if (result)
            {
                this.props.onOk();
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalCreateManufacturer)