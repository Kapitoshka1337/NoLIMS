	...
	<v-card flat>
		...
		<v-card-text>
			...
			<v-card-text>
				<p>
					<h5>Принять</h5>
					Действие доступно при статусе запроса "Рассмотрение". При совершениие данного действия в истории расхода изменится потраченное "Количество" материала, который указан в запросе на исправление и статус запроса перейдет в "Подтвержден".
				</p>
				<p>
					<h5>Отказать</h5>
					Действие доступно при статусе запроса "Рассмотрение". При совершениие данного действия в истории расхода потраченное "Количество" материала, который указан в запросе на исправление, не изменится, а статус запроса перейдет в "Отклонен".
				</p>
			</v-card-text>
			<v-card-text>
