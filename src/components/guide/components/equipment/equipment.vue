				...
				<v-expansion-panels accordion>
					<v-expansion-panel>
						...
						<v-expansion-panel-content>
							<v-card-text>
								Подраздел "Оборудование" позвляет вести учет оборудования и состоит из следующих колонок: Номер, Отдел, Вид, Оборудование, С/Н, Пройденная, Предстоящая, Тэг.
								<v-card-text>
									<p>
										<h5>Номер</h5>
							...
							<v-card-text>
								...
								<v-card-text>
									...
									<p>
										...
										Печать протокола ПТС расположено в шапке таблицы по нажатию кнопки <v-icon color="primary">mdi-print</v-icon>. Перед печатью протокола ПТС необходимо отметить нужное оборудование, после ввести дату проведения осмотра оборудования.
									</p>
									<p>
					...
					<v-expansion-panel>
						...
						<v-expansion-panel-content>
							<v-card-text>
								Подраздел "Поверки" позвляет вести учет отправляемого оборудования на поверку и состоит из следующих колонок: №б, Сформировано, Отправлено, Сформировал, Номер квитанции, Подготовленно/Поверенно.
								<v-card-text>
									<p>
										<h5>№</h5>
