		...
		<v-card-text>
			<v-card-text>
				...
				<v-card-text>
					...
					<p>
						<h5>Статус</h5>
						Отображение состояние запроса на передачу. Статус имеет три состояния: Рассмотрение - первоначальное состояние запроса, Подтвержден - состояние при котором отправитель готов выдать запрашиваемые материалы, Отклонен - состояние при котором отправитель не готов выдать запрашиваемые материалы.
					</p>
				</v-card-text>
			</v-card-text>
			<v-card-text>
			...
			<v-card-text>
				<p>
					...
					Подтвердив запрос на перевод запрашиваемого материала, с склада отправителя переместятся запрашиваемые материалы, согласно указанному местоположению и запрашиваемому количеству.
					В истории расхода появится запись с типом операции «Перевод».
				</p>
				<p>
					<h5>Отказать</h5>
					Действие доступно при статусе запроса "Рассмотрение".
					При отказе перевода запрос сохранится со статусом «Отклонен», перемещение материала не произойдёт.
				</p>
			</v-card-text>
		</v-card-text>
		<v-card>
