<template>
	<v-card-text>
		...
		<ol>
			...
			<li>В открывшемся окне с помощью поиска, найти нужный поступивший материал в соответствии с типом и единицей измерения.</li>
			<li>С помощью <v-checkbox></v-checkbox> выбрать нужный поступивший материал</li>
		</ol>
		<br>
		...
		<v-card-text>
			...
			<p>
				<h5>Плотность</h5>
				Необходимо для перевода единиц измерения материала. Плотность может равнять объему, количеству в упаковке, плотности житких материалов.
			</p>
			<p>
