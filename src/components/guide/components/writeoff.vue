		...
		<v-card-text>
			...
			<v-card-text>
				...
				<v-card-text>
					...
					<p>
						<h5>Накладная</h5>
						Наименование поступившего материала из накладной или универсального передаточного документа. Данное поле добавялется при добавлии нового поступления материалов.
					</p>
					<p>
						<h5>Единица измерения</h5>
						Единица измерения по накладной или универсального передаточного документа, поступившего материала.
					</p>
					<p>
						<h5>Потрачено</h5>
					...
					<p>
						<h5>Поступило</h5>
						Поступившиее количество материала из накладной или универсального передаточного документа.
					</p>
				</v-card-text>
			</v-card-text>
			<v-card>
