...
class ModalCreateDocumentKind extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    handleOk() {
        ...
        .then((values) => {
            let result = agent.DocumentKindService.add(values);
            if (result)
            {
                this.props.onOk();
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalCreateDocumentKind)