...
class ModalCreateType extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    handleOk() {
        ...
        .then((values) => {
            let result = agent.EquipmentTypeService.add(values);
            if (result)
            {
                this.props.onOk();
...
export default connect(mapStateToProps, mapDispatchToProps)(ModalCreateType)