    ...
    constructor(){
        ...
        this.state = {
            ...
            columns: [
                ...
                { renderFilter: (filters) => { return <AutoCompleteDepartment filters={filters} form={true} key={'1'} onOk={this.handleOkAutoCompleteDepartment}/>}, type: 'text', filterIndex: 'departmentId', inFilter: true, inAppearance: true, visible: true, title: 'Отдел', dataIndex: 'department.name', width: 200, sorter: (a, b) => a.department.name - b.department.name > 0 ? 1 : -1},
